...
Each day, there will be a 15 minutes online presentation on a specific topic, followed by 15 minutes for Q&A. To receive the Zoom link for these daily talks, [please register here](https://forms.gle/USfxwRmxnAMMnjow9) (invitations will be sent out before 9 am CET of the respective day). After the event, slides will be available [here](#0).
...
-   **Replication Research with Students via the Collaborative Replication and Education Project (CREP)** by [Lili Lazarevic](https://lira.f.bg.ac.rs/ljiljana-lazarevic-en/) and [Jordan Wagge](https://jordanwagge.com/) (3:30 - 4:00 pm CET), [registration required](https://forms.gle/USfxwRmxnAMMnjow9) ![](logos/CREP.png){width="26" height="20"}\
